...
numaxG = 1.7271; % 2.3279    ;      % max consumption rate of glucose (1.0005)         h^-1       [1]
KSPG   = 0.565;         % affinity constant glucose to ethanol      g/L        [1]
KiPG   = 4890;          % inhibition constant glucose to ethanol    g/L        [1]

p(1:3) = [numaxG, KSPG, KiPG];
%% 2. XYLOSE UPTAKE RATE.
numaxX = 1.6222;        % max consumption rate of xylose            h^-1       [1]
KSPX   = 3.4;          % affinity constant xylose to ethanol       g/L        [1]
KiPX   = 18.1;         % inhibition constant xylose to ethanol     g/L        [1]
...
KiHAcg =  5.6703 ;         % inhibition constant of HAc on Glu         g/L        [2]

p(22) = KiHAcg;
%% 17. HAc INHIBITS XYLOSE UPTAKE RATE.
KiHAcx = 3.8291;       % inhibition constant of HAc on Xyl         g/L        [2]
...
gammaX = 0.608;        % exponent factor inhibition xylose         g/L        [1]
...
KiGlu = 13.763 ;          % inhibition constant of Glu to Xyl         g/L        Unknown
...
par_names = {'numaxG', 'KSPG', 'KiPG', 'numaxX', 'KSPX', 'KiPX', 'numaxFur', 'KSFur', 'Y_FA_Fur', 'KiFAg', 'KiFAx', 'KiFurg', ...
    ...
    'YPSg', 'YPSx', 'PMPg', 'gammaG', 'PMPx', 'gammaX', 'mGlu', 'mXyl', 'YXSg', 'YXSx', 'mumaxG', 'mumaxX', 'KiGlu'};
