...
if biomassa == "Bagaço de Cana-de-Açúcar":
    bagaco1 = st.sidebar.number_input("Parâmetro 1 - Bagaço")
    bagaco2 = st.sidebar.number_input("Parâmetro 2 - Bagaço")
    bagaco3 = st.sidebar.number_input("Parâmetro 3 - Bagaço")
    bagaco4 = st.sidebar.selectbox("Parâmetro 4 - Bagaço", options=["Opção 1", "Opção 2", "Opção 3"])
    bagaco5 = st.sidebar.selectbox("Parâmetro 5 - Bagaço", options=["Opção A", "Opção B", "Opção C"])
    bagaco6 = st.sidebar.selectbox("Parâmetro 6 - Bagaço", options=["Sim", "Não"])
